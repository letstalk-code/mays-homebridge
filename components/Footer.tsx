      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            ...
            <span className={styles.footerLink}>Strategy Sessions</span>
            <span className={styles.footerLink}>Buyer Representation</span>
            <span className={styles.footerLink}>Property Search</span>
            <span className={styles.footerLink}>Negotiation Support</span>
            <span className={styles.footerLink}>Post-Close Support</span>
          </div>
